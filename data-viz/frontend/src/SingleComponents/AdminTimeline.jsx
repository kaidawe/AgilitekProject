...
function AdminTimeline() {
  ...
  const getIntegrationName = () => {
    const integrationId = 'INTEGRATION#01G2QSA76MCHK0ZQXEADJJ4Q6E'
    ...
    <div className="bg-white shadow rounded-lg p-4">
      <div className="flex justify-evenly">
        <div className="flex flex-col">
          <button className="btn-dark" onClick={getIntegrationName}>
            Reset Filters
          </button>
      ...
      <div>
        ...
        >
          ...
          <VictoryBar
            ...
            barWidth={10}
            x={(d) => integrations.find((i) => i.id === d.pk).display_name}
            labels={({ datum }) =>
