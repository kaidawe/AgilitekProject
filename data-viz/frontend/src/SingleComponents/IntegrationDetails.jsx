        ...
        <div className="bg-gray-200 rounded-lg p-4 m-4">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className=" bg-white p-2 rounded-lg">
              <strong className="text-gray-800">Integration Name: </strong>{" "}
              {integration.integration_name}
            </div>
            <div className="bg-white p-2 rounded-lg">
              <strong className="text-gray-800">Data Source: </strong>{" "}
              {integration.data_source}
            </div>
            <div className="bg-white p-2 rounded-lg">
              <strong className="text-gray-800">Data Destination: </strong>{" "}
              {integration.data_destination}
            </div>
            <div className=" bg-white p-2 rounded-lg">
              <strong className="text-gray-800">Run Trigger: </strong>{" "}
              {integration.trigger}
            </div>
          </div>
        </div>
